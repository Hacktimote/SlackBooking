...
module.exports =
  ...
  .factory("$cordovaBeacon", ["$rootScope", function($rootScope) {
    ...
    function onDeviceReady() {
      ...
      var delegate = window.cordova ? new window.cordova.plugins.locationManager.Delegate() : {};
      ...
      window.cordova && window.cordova.plugins.locationManager.setDelegate(delegate);
    ...
    return {
      ...
      requestWhenInUseAuthorization: function() {
        window.cordova && window.cordova.plugins.locationManager.requestWhenInUseAuthorization();
      },
      ...
      requestAlwaysAuthorization: function() {
        window.cordova && window.cordova.plugins.locationManager.requestAlwaysAuthorization();
      },
      ...
      createBeaconRegion: function(identifier, uuid, major, minor) {
        return window.cordova ? new window.cordova.plugins.locationManager.BeaconRegion(identifier, uuid, major, minor) : {};
      },
      ...
      startRangingBeaconsInRegion: function(beaconRegion) {
        window.cordova && window.cordova.plugins.locationManager.startRangingBeaconsInRegion(beaconRegion);
      },
      ...
      startMonitoringForRegion: function(beaconRegion) {
        window.cordova && window.cordova.plugins.locationManager.startMonitoringForRegion(beaconRegion);
      },
      ...
      stopRangingBeaconsInRegion: function(beaconRegion) {
        window.cordova && window.cordova.plugins.locationManager.stopRangingBeaconsInRegion(beaconRegion);
      },
      ...
      stopMonitoringForRegion: function(beaconRegion) {
        window.cordova && window.cordova.plugins.locationManager.stopMonitoringForRegion(beaconRegion);
      }
